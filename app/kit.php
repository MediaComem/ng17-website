...
<body class="kit">
	<div id="news-toastr" class="hidden" title="Information" content="La Deadline a été repoussée au 30 juillet 2017, 00:00"> </div>
        ...
        <div class="inner">
	        ...
	        <div class="container small-container">
		        <div id="landingIntro">
					...
					<h3><span class="light">Deadline pour la livraison est fixée au</span> <s>15</s> 30 juillet 2017, 00h00</h3>
		        </div>
	        </div>
        </div>
    </section>
	...
	<section id="kit-footer" class="negative">
		...
		<div class="container small-container cols">
			...
			<div class="col">
				<h4>Contact</h4>
                    <form id="contact-form" class="gtm_form" action="process.php" method="post" novalidate="novalidate" val-email="Veuillez entrer une adresse email valide." val-req="les champs sont obligatoires">
                    ...
                    <div id="submit-message-contact" success="Merci! Votre email est envoyé." retry="Désolé, votre email n\'a pas pu être envoyé. Veuillez essayer plus tard." failed="Oups, il y a eu un problème.">
